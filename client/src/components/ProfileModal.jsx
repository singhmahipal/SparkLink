...
const ProfileModal = ({setShowEdit}) => {
  ...
  return (
    <div className='fixed top-0 border-0 left-0 right-0 z-110 h-screen overflow-y-scroll bg-black/50'>
                ...
                <form onSubmit={e=>(
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor="profile_picture" className="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <div className="group/profile relative">
                                <img src={editForm.profile_picture ? URL.createObjectURL(editForm.profile_picture) : user.profile_picture} alt="profile pic" className="w-24 h-24 rounded-full object-cover mt-2 " />
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor="cover_photo" className="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <div className="group/profile relative">
                                <img src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo) : user.cover_photo} alt="cover photo" className="w-80 h-40 rounded-lg bg-gradient-to-r from-indigo-200 to-pink-200 object-cover mt-2 " />
                    ...
                    <div className="flex justify-end space-x-3 pt-6">
                        ...
                        <button type='submit' className="px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg text-white hover:from-indigo-600 hover:to-purple-700 transition cursor-pointer">Save Changes</button>
                    </div>
